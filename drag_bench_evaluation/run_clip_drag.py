...
from utils.drag_utils import drag_diffusion_update,drag_diffusion_update_final
...
def run_drag_final(source_image,
   ...
   # initialize model
    ...
    updated_init_code = drag_diffusion_update_final(model, init_code,
...
if __name__ == '__main__':
    ...
    max_iter = 40
    result_dir = f'clip_drag_res_{max_iter}_iterations' + \
